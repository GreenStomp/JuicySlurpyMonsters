...
public static class Utils
{
    ...
    /// <summary>
    /// Sets the given root obj and all child objs to given value of active
    /// </summary>
    /// <param name="rootObject">root obj</param>
    /// <param name="active">active value for all objs</param>
    public static void SetActiveRecursive(this GameObject rootObject, bool active)
    {
        rootObject.SetActive(active);
        foreach (Transform childTransform in rootObject.transform)
        {
            childTransform.SetActiveRecursive(active);
        }
    }
    /// <summary>
    /// Sets the given root obj and all child objs to given value of active
    /// </summary>
    /// <param name="rootObject">root obj transform</param>
    /// <param name="active">active value for all objs</param>
    public static void SetActiveRecursive(this Transform rootObject, bool active)
    {
